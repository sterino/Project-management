...
func (th *TaskHandler) UpdateTask(c *gin.Context) {
	...
	successRes := response.ClientResponse(http.StatusOK, "the task was successfully updated", nil, nil)
	c.JSON(http.StatusOK, successRes)
}
...
func (th *TaskHandler) DeleteTask(c *gin.Context) {
	...
	successRes := response.ClientResponse(http.StatusOK, "the task was successfully deleted", nil, nil)
	c.JSON(http.StatusOK, successRes)
}
